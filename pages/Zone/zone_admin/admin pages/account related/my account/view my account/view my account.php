                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-eye" style="color: white;"></i><a href="../../my account/view my account/view my account.php"><span style="color: white;">View
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">View My Account</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    ...
                                    <h5 class="text-sm-center mt-2 mb-1">Estifanos Aschalel Kassa</h5>
                                    <div class="location text-sm-center"><i class="fa fa-map-marker"></i> Bahir Dar,
                                        Ethiopia</div>
                                    <div class="location text-sm-center"><i class="fa fa-mobile" aria-hidden="true"></i> (251) 918 9955</div>
                                    <div class="location text-sm-center"><i class="fa fa-envelope" aria-hidden="true"></i> estifanosaschale12@gmail.com</div>

                                </div>
                                <hr>
                                <div class="card-text text-sm-center">
                                    <a href="../update my account/update my account.php"><button class="btn btn-primary">Update</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
