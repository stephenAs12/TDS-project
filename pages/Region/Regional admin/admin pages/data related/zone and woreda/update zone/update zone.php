                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-pencil-square-o" style="color: white;"></i><a href="../../../data related/zone and woreda/update zone/update zone.php"><span style="color: white;">Update</span></a></li>
