        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    Hello Estifanos, Your Dashboard <span class="badge badge-pill badge-success">Successfully</span>
                    rendered !
            ...
            $zoneTdsQuery = "SELECT user_id FROM users WHERE urole='zone TDS Expert' ORDER BY user_id";
