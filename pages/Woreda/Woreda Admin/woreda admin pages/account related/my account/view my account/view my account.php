                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mx-auto d-block">
                                        ...
                                        <div class="location text-sm-center"><i class="fa fa-map-marker"></i> <?php echo  $_SESSION['user_address']; ?>,
                                            Ethiopia</div>
                                        <div class="location text-sm-center"><i class="fa fa-mobile" aria-hidden="true"></i> (251) <?php echo  $_SESSION['user_phone']; ?></div>
