...
jQuery(document).ready(function () {
  ...
  var numTeacher = jQuery('#num_teacher_id').val();

  


  jQuery('#requirement_form_id').validate({
      rules: {
          'school_name': {
              required: true,
              minlength: 1
      ...
      submitHandler: function () {
          var formData = new FormData(document.getElementById("requirement_form_id"));
          jQuery.ajax({
              type: 'POST',
              url: 'insert requirement.php',
              data: formData,
              processData: false,
              contentType: false,
