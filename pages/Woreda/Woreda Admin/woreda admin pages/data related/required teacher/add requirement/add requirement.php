...
?>
    ...
    <body>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-plus-square" style="color: white;"></i><a href="../../../data related/school/add school/add school.php"><span style="color: white;">Add Schools</span></a></li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-plus-square"></i><a href="./add requirement.php">require teacher</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form id="requirement_form_id" class="">
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="num_teacher_name" id="num_teacher_id" placeholder="Number of teacher" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
        ...
        <script src="./add/insert requirement.js"></script>
