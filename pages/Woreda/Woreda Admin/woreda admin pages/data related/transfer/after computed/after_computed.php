    ...
    <body>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-step-backward" style="color: white;"></i><a href="../../../data related/transfer/before computed/before_computed.php"> <span style="color: white;">Before Computed</span> </a></li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            if (mysqli_connect_errno()) {
                ...
                $selectQuery = "SELECT * FROM `result` WHERE woreda='$userWoreda' OR new_woreda='$userWoreda'";
