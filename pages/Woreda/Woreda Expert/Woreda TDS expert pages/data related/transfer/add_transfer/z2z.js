...
jQuery(document).ready(function () {
    ...
    var zoneOne = jQuery('#z2z_zone1_id').val();
    var regionTwo = jQuery('#r2r_region2_id').val();
    var regionTwo = jQuery('#r2r_region2_id').val();
    var regionTwo = jQuery('#r2r_region2_id').val();

    var zoneTwo = jQuery('#z2z_zone2_id').val();
    var regionTwo = jQuery('#r2r_region2_id').val();
    var regionTwo = jQuery('#r2r_region2_id').val();
    var regionTwo = jQuery('#r2r_region2_id').val();

    jQuery('#z2z_form_id').validate({
        rules: {
            'z2z_zone1_name': {
                required: true,
                minlength: 1
        ...
        submitHandler: function () {
            var formData = new FormData(document.getElementById("z2z_form_id"));
            jQuery.ajax({
                type: 'POST',
                url: 'z2z.php',
                data: formData,
