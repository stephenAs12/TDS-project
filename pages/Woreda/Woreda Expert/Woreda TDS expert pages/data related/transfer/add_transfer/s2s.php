...
session_start();
    ...
    $sql = "INSERT INTO transfer_request(teacher_id,request_type,school_one,school_two, school_three) VALUES ('$knownID','$transferType','$schoolOne','$schoolTwo', '$schoolThree')";
