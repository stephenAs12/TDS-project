                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="" method="get">
                                    ...
                                    <button type="submit" class="btn btn-success" style="margin-top: 32px;">Search Teacher</button>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <div class="col-sm-12" id="region_label_id">
                                                    ...
                                                    <div id="region_id">
                                                        <div class="form-group col-md-6">
                                                            <label for="r2r_region1_id" id="" class="form-label">Region 1
                                                            </label>
                                                            <div class="input-group">
                                                                <div class="input-group-addon"><i class="fa fa-university" aria-hidden="true"></i>
                                                                </div>
                                                                <select name="r2r_region1_name" id="r2r_region1_id" class='form-control' required>
                                                                    <option value="" selected disabled hidden>Please Select Region 1</option>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="r2r_region2_id" id="" class="form-label">Region 2
                                                            </label>
                                                            <div class="input-group">
                                                                <div class="input-group-addon"><i class="fa fa-university" aria-hidden="true"></i>
                                                                </div>
                                                                <select name="r2r_region2_name" id="r2r_region2_id" class='form-control' required>
                                                                    <option value="" selected disabled hidden>Please Select Region 2</option>
                                                                    <option value="Addis Ababa (city)">Addis Ababa (city)</option>
                                                                    <option value="Afar Region">Afar Region</option>
                                                                    <option value="Amhara Region">Amhara Region</option>
                                                                    <option value="	Benishangul-Gumuz Region">Benishangul-Gumuz Region</option>
                                                ...
                                                <form action="" method="post">
                                                    <div class="col-sm-12" id="zone_label_id">
                                                        <div class="alert  alert-success alert-dismissible fade show text-center" role="alert">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <div class="form-group col-md-3">
                                                                    <label for="z2z_zone1_id" id="" class="form-label">Zone 1
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <?php
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label for="z2z_woreda1_id" id="" class="form-label">Woreda 1
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <?php
                                                                        ...
                                                                        echo "<option value='' selected hidden>Please select Woreda 1 *</option>";
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label for="z2z_woreda2_id" id="" class="form-label">Woreda 2
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <?php
                                                                        // include 'add user/get address.php';
                                                                        echo "<div class='input-group-addon'><i class='fa fa-map-marker' aria-hidden='true'></i></div>";
                                                                        echo "<select name='z2z_woreda2_name' id='z2z_woreda2_id' class='form-control' required>";
                                                                        echo "<option value='' selected hidden>Please select Woreda 2*</option>";
                                                                        // while ($address_row = mysqli_fetch_array($address_resualt)) {
                                                                        //     echo "<option value='$address_row[zone_id]'>$address_row[zone_name]</option>";
                                                                        // }
                                                                        echo "</select>";
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label for="z2z_zone1_173_id" id="" class="form-label">In Any
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <input class="form-check-input" type="checkbox" value="" id="z2z_zone1_173_id">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <div class="form-group col-md-3">
                                                                    <label for="z2z_zone2_id" id="" class="form-label">Zone 2
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <?php
                                                                        include 'support/get zone.php';
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label for="z2z_woreda11_id" id="" class="form-label">Woreda 1
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <?php
                                                                        // include 'add user/get address.php';
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label for="z2z_woreda22_id" id="" class="form-label">Woreda 2
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <?php
                                                                        // include 'add user/get address.php';
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label for="z2z_zone2_173_id" id="" class="form-label">In Any
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <input class="form-check-input" type="checkbox" value="" id="z2z_zone2_173_id">
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <div class="col-sm-12" id="woreda_label_id">
                                                        <div class="alert  alert-success alert-dismissible fade show text-center" role="alert">
                                                    ...
                                                    <div id="woreda_id">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <div class="form-group col-md-4">
                                                                <label for="w2w_woreda1_id" id="" class="form-label">Woreda 1
                                                                </label>
                                                                <div class="input-group">
                                                                    <div class="input-group-addon"><i class="fa fa-university" aria-hidden="true"></i>
                                                                    </div>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                <label for="w2w_woreda2_id" id="" class="form-label">Woreda 2
                                                                </label>
                                                                <div class="input-group">
                                                                    <div class="input-group-addon"><i class="fa fa-university" aria-hidden="true"></i>
                                                                    </div>
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                <label for="w2w_173_id" id="" class="form-label">In Any
                                                                </label>
                                                                <div class="input-group">
                                                                    <input class="form-check-input" type="checkbox" value="" id="w2w_173_id">
                                                ...
                                                <form action="" method="post">
                                                    <div class="col-sm-12" id="school_label_id">
                                                        <div class="alert  alert-success alert-dismissible fade show text-center" role="alert">
                                                    ...
                                                    <div id="school_id">
                                                        <div class="form-group col-md-4">
                                                            <div class="input-group">
                                                                ...
                                                                echo "<option value='' selected hidden>Please select School *</option>";
        ...
        jQuery(document).ready(function() {
            jQuery("#z2z_zone1_id").change(function() {
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        jQuery("#z2z_woreda1_id").html(data);
                        jQuery("#z2z_woreda2_id").html(data);
                    }
                });
