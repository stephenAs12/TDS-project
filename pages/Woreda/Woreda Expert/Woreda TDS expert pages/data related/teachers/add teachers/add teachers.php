                                ...
                                <form id="teacher_form_id" class="">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="teacher_id_name" id="teacher_id_id" placeholder="Teacher ID" class="form-control" autocomplete="off" minlength="3" required readonly value="<?php echo $teacherId;?>">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="first_name_name" id="first_name_id" placeholder="First Name" class="form-control" autocomplete="off" minlength="3" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="middle_name_name" id="middle_name_id" placeholder="Middle Name" class="form-control" autocomplete="off" minlength="3" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="last_name_name" id="last_name_id" placeholder="Last Name" class="form-control" autocomplete="off" minlength="3" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select name="education_level_name" id="education_level_id" class='form-control' required>
                                                <option value="" selected disabled hidden>Please Select Education Level</option>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="major_name" id="major_id" placeholder="Department(Major)" class="form-control" autocomplete="off" minlength="3" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                    ...
                                    <div class="form-group col-md-6">
                                        <select id="school_id" name="school_name" data-placeholder="Choose a School..." class="standardSelect" tabindex="1" required>
                                            <option value=""></option>
                                            <?php
                                            while ($school_row = mysqli_fetch_array($school_resualt)) {
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input name="employment_period_name" placeholder="Select date" type="date" id="employment_period_id" class="form-control" minlength="10" maxlength="10" required>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div>
                                            ...
                                            <div class="input-group-addon col-md-2">Gender</div>
                                            <div class="col col-md-4">
                                                <div class="form-check">
                                                    <div class="radio">
                                                        <label for="male_id" class="form-check-label ">
                                                            <input type="radio" id="male_id" name="sex_radio" value="Male" class="form-check-input" required>Male
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label for="female_id" class="form-check-label ">
                                                            <input type="radio" id="female_id" name="sex_radio" value="Female" class="form-check-input" required>Female
                                                        </label>
                                                    </div>
                                        ...
                                        <div>
                                            <div class="input-group-addon col-md-2">Disable</div>
                                            <div class="col col-md-4">
                                                <div class="form-check">
                                                    <div class="radio">
                                                        <label for="disable_yes_id" class="form-check-label ">
                                                            <input type="radio" id="disable_yes_id" name="disable_radio" value="Yes" class="form-check-input" required>Yes
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label for="disable_no_id" class="form-check-label ">
                                                            <input type="radio" id="disable_no_id" name="disable_radio" value="No" class="form-check-input" required>No
                                                        </label>
                                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div>
                                            <div class="input-group-addon col-md-2">Married</div>
                                            <div class="col col-md-4">
                                                <div class="form-check">
                                                    <div class="radio">
                                                        <label for="married_yes_id" class="form-check-label ">
                                                            <input type="radio" id="married_yes_id" name="married_radio" value="Yes" class="form-check-input" required>Yes
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label for="married_no_id" class="form-check-label ">
                                                            <input type="radio" id="married_no_id" name="married_radio" value="No" class="form-check-input" required>No
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="form-check">
                                                    <div class="radio">
                                                        <label for="nominee_yes_id" class="form-check-label ">
                                                            <input type="radio" id="nominee_yes_id" name="nominee_radio" value="Yes" class="form-check-input" required>Yes
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label for="nominee_no_id" class="form-check-label ">
                                                            <input type="radio" id="nominee_no_id" name="nominee_radio" value="No" class="form-check-input" required>No
                                                        </label>
                                                    </div>
                                    ...
                                    <div class="form-actions form-group">
                                        ...
                                        <button type="submit" id="teacher_submit_id" name="submit" class="btn btn-success btn-sm">Submit</button>
